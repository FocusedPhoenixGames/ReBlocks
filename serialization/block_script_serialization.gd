...
const ASTList = preload("res://addons/reblocks/code_generation/ast_list.gd")
const BlockAST = preload("res://addons/reblocks/code_generation/block_ast.gd")
const BlockCategory = preload("res://addons/reblocks/ui/picker/categories/block_category.gd")
const BlockDefinition = preload("res://addons/reblocks/code_generation/block_definition.gd")
const BlockSerialization = preload("res://addons/reblocks/serialization/block_serialization.gd")
const BlockSerializationTree = preload("res://addons/reblocks/serialization/block_serialization_tree.gd")
const BlocksCatalog = preload("res://addons/reblocks/code_generation/blocks_catalog.gd")
const CategoryFactory = preload("res://addons/reblocks/ui/picker/categories/category_factory.gd")
const Types = preload("res://addons/reblocks/types/types.gd")
const ValueBlockSerialization = preload("res://addons/reblocks/serialization/value_block_serialization.gd")
const VariableDefinition = preload("res://addons/reblocks/code_generation/variable_definition.gd")

const SCENE_PER_TYPE = {
	Types.BlockType.ENTRY: preload("res://addons/reblocks/ui/blocks/entry_block/entry_block.tscn"),
	Types.BlockType.STATEMENT: preload("res://addons/reblocks/ui/blocks/statement_block/statement_block.tscn"),
	Types.BlockType.VALUE: preload("res://addons/reblocks/ui/blocks/parameter_block/parameter_block.tscn"),
	Types.BlockType.CONTROL: preload("res://addons/reblocks/ui/blocks/control_block/control_block.tscn"),
}
