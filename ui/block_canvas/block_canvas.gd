...
const DragManager = preload("res://addons/reblocks/drag_manager/drag_manager.gd")
const ScriptGenerator = preload("res://addons/reblocks/code_generation/script_generator.gd")
